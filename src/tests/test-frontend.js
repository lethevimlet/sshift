...
async function test() {
  ...
  const tests = [
    { name: 'Main page', url: 'process.env.SERVER_URL || 'http://localhost:8022'/' },
    { name: 'app.js', url: 'process.env.SERVER_URL || 'http://localhost:8022'/js/app.js' },
    { name: 'style.css', url: 'process.env.SERVER_URL || 'http://localhost:8022'/css/style.css' },
    { name: 'socket.io', url: 'process.env.SERVER_URL || 'http://localhost:8022'/socket.io/socket.io.js' },
